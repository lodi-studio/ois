...
<div class="container">
    ...
    <div class="float-right">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="<?php echo base_url('home');?>">Dispatch</a>
          <a class="dropdown-item" href="<?php echo site_url('Home/getarrival'); ?>">Arrival</a>
        </div>
      </div>
    <br><br/>
    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
        <?php foreach($data['dispatch']->result() as $row) : ?>
            <tr>
